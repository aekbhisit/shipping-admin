    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Add New Carrier</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('admin.carriers.index') }}">Carriers</a>
                            </li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0"><i class="bx bx-plus me-2"></i>Carrier Information</h5>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            @error('code')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="form-text text-muted">Unique identifier for the carrier (e.g., DHL, FEDEX)</small>
                                        </div>
                                    </div>
                                </div>
