            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">เพิ่มเครดิต</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
                ...
                <div class="card border-top border-0 border-4 border-success">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-success">+ เพิ่มเครดิตมือ</h5>
                        </div>
                        <hr>
                        <form class="row g-3" id="manual_credit_frm" name="manual_credit_frm" method="POST" onsubmit="setSave(); return false;" enctype="multipart/form-data">
                            ...
                            <div class="col-12">
                                ...
                                <select id="username" name="username" class="form-control select2-ajax-with-image form-select" 
                                    ...
                                    data-selected-image="" 
                                    data-ajax-url="/admin/customer/user/get_user" 
                            ...
                            <div class="form-group frm-name">
                             ...
                             <div class="form-group frm-name">
                                ...
                                <input type="text" class="form-control" name="ref_code" id="ref_code" placeholder="รหัสอ้างอิง" value="">
                            </div>
