                ...
                <div class="col-xl-12 mx-auto">
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            ...
                            <form class="row g-3" id="main_user_frm" name="main_user_frm" method="POST" onsubmit="setMainUserSave(); return false;" enctype="multipart/form-data">
                                @csrf
...
@section('scripts')
    <script>
        ...
        setMainUserSave = function setMainUserSave() {
            event.preventDefault();
            var frm_data = new FormData($('#main_user_frm')[0]);
