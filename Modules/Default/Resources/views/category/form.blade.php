...
<a href="{{ route('admin.homepage') }}"><i class="bx bx-home-alt"></i></a>
        ...
        <div class="row">
            ...
            <form id="category_frm" name="category_frm" method="POST" onsubmit="setSave(); return false;" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="card-body p-5">
                        ...
                        <ul class="nav nav-tabs nav-warning" role="tablist" id="main-tab">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" data-bs-toggle="tab" href="#main_tab_content" role="tab" aria-selected="true">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" data-bs-toggle="tab" href="#main_tab_seo" role="tab" aria-selected="false">
                                    <div class="d-flex align-items-center">
                        ...
                        <div class="tab-content py-3">
                            <!-- tab::category -->
                                @includeIf('default::category.form.form_tab')
                            <!-- tab::category -->
                            <!-- tab::seo -->
                                @includeIf('default::seo.form')
                            <!-- tab::seo -->   
                        </div>  
