<form class="row g-3" onsubmit="setReloadDataTable(); return false; ">
    <div class="col-md-10">
        <div class="row">
            ...
            <div class="col-md-2">
                <label for="bank_id" class="form-label datatable_filter">Bank</label>
                <select id="bank_id" name="filter[bank_id]"
                    class="form-control select2-ajax-with-image form-group datatable_filter form-select"
                    data-ajax-url="/admin/crm/bank/get_bank" data-lang-placeholder="เลือก Bank"
                    data-lang-searching="กำลังโหลด">
                </select>
            </div>
            <div class="col-md-2">
