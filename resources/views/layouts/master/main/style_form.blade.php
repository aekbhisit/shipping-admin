...
<link href="{{ URL::asset('assets/plugins/font-awesome-4/css/font-awesome.min.css') }}" rel="stylesheet" />
<link href="{{ URL::asset('assets/plugins/font-awesome-5/css/fontawesome.min.css') }}" rel="stylesheet" />
