				...
				<div class="card-body">
					<div class="p-4 rounded  border">
						<div class="text-center">
							<img src="{{URL::asset('assets/images')}}/icons/forgot-2.png" width="120" alt="" />
						</div>
						...
						<div class="d-grid gap-2">
							<button type="button" class="btn btn-primary btn-lg">Send</button> <a href="{{ route('rukada.template', 'authentication-signin') }}" class="btn btn-light btn-lg"><i class='bx bx-arrow-back me-1'></i>Back to Login</a>
						</div>
					</div>
				</div>
			</div>
