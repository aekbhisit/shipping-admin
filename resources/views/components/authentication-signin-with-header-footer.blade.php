			...
			<nav class="navbar navbar-expand-lg navbar-light bg-white rounded fixed-top rounded-0 shadow-sm">
				<div class="container-fluid">
					<a class="navbar-brand" href="#">
						<img src="{{URL::asset('assets/images')}}/logo-img.png" width="140" alt="" />
					</a>
								...
								<div class="border p-4 rounded">
									...
									<div class="form-body">
										<form class="row g-4">
											...
											<div class="col-md-6 text-end">	<a href="{{ route('rukada.template', 'authentication-forgot-password') }}">Forgot Password ?</a>
											</div>
											<div class="col-12">
												<div class="d-grid">
											...
											<div class="col-12 text-center">
												<p class="mb-0">Don't have an account yet? <a href="{{ route('rukada.template', 'authentication-signup') }}">Sign up here</a>
												</p>
											</div>
										</form>
									</div>
