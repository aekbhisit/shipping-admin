		...
		<div class="error-404 d-flex align-items-center justify-content-center">
			<div class="card shadow-none bg-transparent">
				<div class="card-body text-center">
					<h1 class="display-4 mt-5 text-white">We are Coming Soon!</h1>
					<p class="text-white">We are currently working hard on this page. Subscribe our newsletter
					...
					<div class="row">
						<div class="col-12 col-lg-12 mx-auto">
							...
							<h4 class="mt-3 text-white">Follow Us :</h4>
